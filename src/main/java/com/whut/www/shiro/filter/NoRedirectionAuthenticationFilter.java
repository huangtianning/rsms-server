...
public class NoRedirectionAuthenticationFilter extends FormAuthenticationFilter {
	private static final String MESSAGE = "Access denied. You are not logged in yet.";
